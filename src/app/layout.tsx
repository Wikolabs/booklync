...
export const metadata: Metadata = {
  title: "BookLync — Prise de rendez-vous automatisee par l'IA",
  description: "BookLync detecte l'intention d'achat, propose des creneaux, confirme le RDV et envoie le brief pre-call automatiquement.",
};
